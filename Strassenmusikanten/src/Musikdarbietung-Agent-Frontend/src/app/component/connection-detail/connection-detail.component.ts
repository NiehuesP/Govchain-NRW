...
import {MusikdarbietungComponent} from '../musikdarbietung/musikdarbietung.component';
...
export class ConnectionDetailComponent implements OnInit {
  ...
  connectionId: string;
  state: string;
  pendingCredentials: any = null;
  acceptedCredentials: any = null;
  ...
  openMusikdarbietung(): void {
    const dialogConfig = new MatDialogConfig();
    dialogConfig.autoFocus = true;
    this.dialog.open(MusikdarbietungComponent, {
      data: {
