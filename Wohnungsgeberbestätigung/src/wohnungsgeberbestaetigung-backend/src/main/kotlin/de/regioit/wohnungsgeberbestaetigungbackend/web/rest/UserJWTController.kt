...
import de.regioit.wohnungsgeberbestaetigungbackend.security.jwt.JWTFilter
import de.regioit.wohnungsgeberbestaetigungbackend.security.jwt.TokenProvider
import de.regioit.wohnungsgeberbestaetigungbackend.service.UserService
import de.regioit.wohnungsgeberbestaetigungbackend.web.rest.vm.LoginVM
...
class UserJWTController(private val tokenProvider: TokenProvider,
    ...
    fun authorize(@RequestBody @Valid loginVM: LoginVM?): ResponseEntity<*> {
        ...
        return try {
            ...
            ResponseEntity<Any?>(error_msg, org.springframework.http.HttpHeaders(), HttpStatus.BAD_REQUEST)
